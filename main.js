window.addEventListener("DOMContentLoaded", () => {
    ...
    const events = [
        ...
        { time: "11:00 - 14:00", day: "Вт", className: "Длинное название названиеназвание", instructor: "Фамилия Имя" },
        { time: "11:00 - 11:30", day: "Пт", className: "Длинное название названиеназвание", instructor: "Фамилия Имя" },
        { time: "12:00 - 14:30", day: "Пт", className: "Длинное название названиеназвание", instructor: "Фамилия Имя" },
    ];
